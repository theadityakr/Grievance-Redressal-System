 ...
 * @author thead
 */
public class auth_reply extends javax.swing.JFrame {
  ...
  try{
   ...
   jTextArea2.setText(descrip);
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Inappropriate / Threats");
 ...
 ResultSet resobj=null;
     ...
     databaseHandler.execAction(query);
        ...
        this.hide();
        auth_complaints back=new auth_complaints();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String query="SELECT * FROM LOGIN where LOGIN.ID='"+temp+"'";
  ...
  resobj=null;
       ...
       resobj =databaseHandler.execQuery(query);
        ...
        while(resobj.next()){
         ...
         if(jRadioButton1.isEnabled()==true){
                  query="INSERT INTO THREAT VALUES("
                + "'" + grievance_id + "',"
                + "'" + date + "',"
                + "'" + subject + "',"
                + "'" + name + "',"
	...
	date=formatter.format(datex);
     ...
     databaseHandler.execAction(query);
         ...
         JOptionPane.showMessageDialog(this,"Replied to the Complaint Successfully");
          query= "DELETE FROM REPLY_TABLE WHERE REPLY_TABLE.GRIEVANCE_ID ='"+grievance_id+"'"; 
     databaseHandler.execAction(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(auth_reply.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new auth_reply().setVisible(true);
            }
        });
    }
