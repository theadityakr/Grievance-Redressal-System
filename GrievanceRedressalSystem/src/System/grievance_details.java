 ...
 * @author thead
 */
public class grievance_details extends javax.swing.JFrame {
  ...
  try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(grievance_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new grievance_details().setVisible(true);
            }
        });
    }
